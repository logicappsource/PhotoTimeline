...
//  InstaFeed
//
//  Created by Patrick on 13/06/16.
...
class ExploreCollectionViewController: UICollectionViewController {
    ...
    struct Storyboard {
        static let CellIdentifier = "ExplorePhotoCell"
    }
    ...
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        as! ExplorePhotoCollectionViewCell
    
        // Configure the cell
        
        cell.imageView.image = UIImage(named: "Screen Shot 2016-06-09 at 23.25.18")
        return cell
    }
